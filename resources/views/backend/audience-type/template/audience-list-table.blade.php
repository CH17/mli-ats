                        ...
                        <tr class="gradeX DrapRow" item_id="{{$audience->id}}">
                            ...
                            <td class="action-column tooltip-suggestion">
                                <a class="btn btn-success btn-circle"
                                    href="{{ route('audience-types.edit', $audience->id) }}" data-toggle="tooltip"
                                    data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>
                                @if(!empty($user_role) && $user_role=='ADMIN')
                                <form method="POST" action="{{ route('audience-types.destroy', $audience->id) }}"
                                    class="action-form">
                                    @csrf
                                    {{ method_field('DELETE') }}
