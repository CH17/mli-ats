<div id="act-par-import-csv-form">
    <form action="{{ route('activity.participant.import', ['project_id' => $project_id]) }}" method="POST"
        ...
        <div class="ibox float-e-margins outcome">
            ...
            <div class="ibox-content">
                <div class="col-md-12 pl-0">
                    @if(count($activity_participants) > 0)
                    <div class="AvailableBatch">
                        @foreach ($activity_participants as $activity_participant)
                        <label>Batch: {{$activity_participant->batch}} Updated at:
                            {{$activity_participant->updated_at->format('d/m/Y')}}</label><br>
                        @endforeach
                    </div>
                    @else
        ...
        <div class="ibox float-e-margins outcome">
            <div class="ibox-title">
                <div class="titleWrap">
                    <h5>Upload Activity Participant Report</h5>
                </div>
            </div>
            <div class="ibox-content">
                ...
                <div class="col-md-12 pl-0">
                    <label for="Import" class="OutcomeLevel">Activity Participant Report CSV:</label>
