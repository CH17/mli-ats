                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group @error('board_code') has-error @enderror">
                                ...
                                <input type="text" name="board_code" id="board_code" value="{{old('board_code')}}"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group @error('moc_code') has-error @enderror">
                                ...
                                <input type="text" name="moc_code" id="moc_code" value="{{old('moc_code')}}" class="form-control">
                                @error('moc_code')
                                <div class="inline-errors">{{ $message }}</div>
                                @enderror
                            </div>
