    ...
    <div class="ibox-title">
        ...
        <div class="panelToolboxWrap text-right">
            <ul class="nav panel_toolbox">
                <li class="first">
                    <a href="{{ route('reports.jac-14-csv') }}"
                 ...
                 <li class="first">
                    <a href="{{ route('reports.jac-14-excel') }}"
                ...
                <li class="last">
                    <a href="{{ route('reports.jac-14-pdf') }}"
        ...
        <table class="table table-striped table-bordered table-hover tooltip-suggestion">
            ...
            <tbody>
                ...
                <tr class="gradeX">
                    ...
                    <td data-toggle="tooltip" data-placement="top" title="{!! $project->jac14_description !!}">{!!
                        Str::words($project->jac14_description, 4,' ....') !!}</td>
