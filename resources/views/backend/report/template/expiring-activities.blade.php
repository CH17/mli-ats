    ...
    <div class="ibox-title">
        ...
        <div class="panelToolboxWrap text-right tooltip-suggestion">
            <ul class="nav panel_toolbox">
                <li class="first">
                    <a href="{{ route('reports.expiring-activity-csv') }}" data-toggle="tooltip" data-placement="top"
                        title="Download CSV">
                ...
                <li class="first">
                    <a href="{{ route('reports.expiring-activity-excel') }}" data-toggle="tooltip" data-placement="top"
                ...
                <li class="last">
                    <a href="{{ route('reports.expiring-activity-pdf') }}" target="_blank" data-toggle="tooltip"
        ...
        <table class="table table-striped table-bordered table-hover table-Sorting tooltip-suggestion">
            <thead>
                <tr>
                    ...
                    <th class="sorting">
                        <div><a href="?order_by=expiration_date&sort_order={{$next_order}}"><i
                                    class="fa fa-fw fa-sort"></i> Days To Expiration</a></div>
                    </th>
                    <th>PM</th>
