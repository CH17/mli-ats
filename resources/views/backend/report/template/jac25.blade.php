    ...
    <div class="ibox-title">
        ...
        <div class="panelToolboxWrap text-right">
            <ul class="nav panel_toolbox">
                ...
                <li class="last">
                    <a href="{{ route('reports.jac-25-pdf') }}"
        ...
        <table class="table table-striped table-bordered table-hover tooltip-suggestion">
            ...
            <tbody>
                ...
                <tr class="gradeX">
                    ...
                    <td data-toggle="tooltip" data-placement="top" title="{!! $project->jac25_description !!}">{!!
                        Str::words($project->jac25_description, 4,' ....') !!}</td>
