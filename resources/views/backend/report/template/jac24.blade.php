<div class="ibox float-e-margins">
    ...
    <div class="ibox-title">
        <div class="titleWrap">
            <h5>JAC 24 – IPCE QI Improvements</h5>
        </div>
        <div class="panelToolboxWrap text-right">
            <ul class="nav panel_toolbox">
                <li class="first">
                    <a href="{{ route('reports.jac-24-csv') }}"
                ...
                <li class="first">
                    <a href="{{ route('reports.jac-24-excel') }}"
                ...
                <li class="last">
                    <a href="{{ route('reports.jac-24-pdf') }}"
        ...
        <table class="table table-striped table-bordered table-hover tooltip-suggestion">
            ...
            <tbody>
                ...
                <tr class="gradeX">
                    ...
                    <td data-toggle="tooltip" data-placement="top" title="{!! $project->jac24_description !!}">{!!
                        Str::words($project->jac24_description, 4,' ....') !!}</td>
