<div class="ibox float-e-margins">
    ...
    <div class="ibox-title">
        <div class="titleWrap">
            <h5>JAC 17 – Health & Practice</h5>
        </div>
        <div class="panelToolboxWrap text-right">
            <ul class="nav panel_toolbox">
                <li class="first">
                    <a href="{{ route('reports.jac-17-csv') }}"
                ...
                <li class="first">
                    <a href="{{ route('reports.jac-17-excel') }}"
                ...
                <li class="last">
                    <a href="{{ route('reports.jac-17-pdf') }}"
        ...
        <table class="table table-striped table-bordered table-hover tooltip-suggestion">
            ...
            <tbody>
                ...
                <tr class="gradeX">
                    ...
                    <td data-toggle="tooltip" data-placement="top" title="{!! $project->jac17_description !!}">{!!
                        Str::words($project->jac17_description, 4,' ....') !!}</td>
