<div class="ibox float-e-margins">
    ...
    <div class="ibox-title">
        <div class="titleWrap">
            <h5>JAC 18 – Factors Outside Control</h5>
        </div>
        <div class="panelToolboxWrap text-right">
            <ul class="nav panel_toolbox">
                <li class="first">
                    <a href="{{ route('reports.jac-18-csv') }}"
                        rel="tooltip" data-placement="bottom" title="Download CSV">
                        <i class="fa fa-file-excel-o"></i> CSV
                    </a>
                </li>         
                <li class="first">
                    <a href="{{ route('reports.jac-18-excel') }}"
                ...
                <li class="last">
                    <a href="{{ route('reports.jac-18-pdf') }}"
        ...
        <table class="table table-striped table-bordered table-hover tooltip-suggestion">
            ...
            <tbody>
                ...
                <tr class="gradeX">
                    ...
                    <td data-toggle="tooltip" data-placement="top" title="{!! $project->jac18_description !!}">{!!
                        Str::words($project->jac18_description, 4,' ....') !!}</td>
