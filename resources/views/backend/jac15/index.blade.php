...
@section('title', 'JAC15 - Training')
@section('content')

<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>JAC15 - Training</h2>
        <ol class="breadcrumb">
            <li>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="ibox-content">
                            ...
                            @endif
                            <form action="{{route('jac15.store')}}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group @error('year_quarter') has-error @enderror">
                                            ...
                                            <input name="year_quarter" type="text" value="" class="form-control">
                                            @error('year_quarter')
                                            <div class="inline-errors">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group @error('ipce_team') has-error @enderror">
                                            ...
                                            <textarea type="text" name="ipce_team" class="form-control"></textarea>
                                            @error('ipce_team')
                                            <div class="inline-errors">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group @error('cpd_need') has-error @enderror">
                                            ...
                                            <textarea type="text" name="cpd_need" class="form-control"></textarea>
                                            @error('cpd_need')
                                            <div class="inline-errors">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group @error('learning_plan') has-error @enderror">
                                            ...
                                            <textarea type="text" name="learning_plan" class="form-control"></textarea>
                                            @error('learning_plan')
                                            <div class="inline-errors">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group @error('time_resources') has-error @enderror">
                                            ...
                                            <textarea type="text" name="time_resources" class="form-control"></textarea>
                            ...
                            <table class="table table-striped table-bordered table-hover tooltip-suggestion">
                                ...
                                <tbody id="Jac15">
                                    ...
                                    <tr class="gradeX">
                                        ...
                                        <td data-toggle="tooltip" data-placement="top" title="{{ $jac15->ipce_team }}">
                                            {{Str::words($jac15->ipce_team, 4,' ....') }}</td>
